...
#################################################################################################################
dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/ethiopia2.csv'), delimiter=',', quotechar='"')
#ataReader = csv.reader(open('/app/ethiopia2.csv'), delimiter=',', quotechar='"')
#################################################################################################################
