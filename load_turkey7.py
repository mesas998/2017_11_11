...
if 'Users' in (os.environ['HOME']):
  dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/turkey7.csv'), delimiter=',', quotechar='"')
else:
  dataReader = csv.reader(open('/app/turkey7.csv'), delimiter=',', quotechar='"')
#################################################################################################################
