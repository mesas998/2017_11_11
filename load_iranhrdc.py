...
if 'Users' in (os.environ['HOME']):
  dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/iranhrdc.csv'), delimiter=',', quotechar='"')
else:
  dataReader = csv.reader(open('/app/iranhrdc.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    # 2) actually the save() in nutr/models.py POC model sets the slug
    clone2=row[0][:]
    ...
    try:
        print('30a')
        poc.link = 'http://www.iranhrdc.org'
        print('30b')
    except:
        pass
