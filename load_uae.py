...
if 'Users' in (os.environ['HOME']):
  dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/uae.csv'), delimiter=',', quotechar='"')
else:
  dataReader = csv.reader(open('/app/uae.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'http://www.ic4jhr.org/en/prisoners/126-political-prisoners-in-the-uae.html'
        print('30b')
    except:
        pass
