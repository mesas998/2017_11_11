...
if 'Users' in (os.environ['HOME']):
  dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/georgia6.csv'), delimiter=',', quotechar='"')
else:
  dataReader = csv.reader(open('/app/georgia6.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'http://www.freegeorgia.ge/uploads/files_26_2.pdf'
        print('30b')
    except:
        pass
