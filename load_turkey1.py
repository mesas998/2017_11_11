...
#################################################################################################################
#ataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/turkey1.csv'), delimiter=',', quotechar='"')
dataReader = csv.reader(open('/app/turkey1.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'https://peaceinkurdistancampaign.com/2017/03/20/imprisoned-co-mayors-from-kurdish-region-turkey/#more-7662'
        print('30b')
    except:
        pass
    ...
    try:
        ...
        list2.append(' '+row[4][:])
        print('32e: ',type(row[5][:]))
        list2.append(' '+str(row[5][:]))
        print('32f: ',type(row[6][:]))
