...
if 'Users' in (os.environ['HOME']):
  dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/namibia1.csv'), delimiter=',', quotechar='"')
else:
  dataReader = csv.reader(open('/app/namibia1.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'https://en.wikipedia.org/wiki/Caprivi_treason_trial'
        print('30b')
    except:
        pass
