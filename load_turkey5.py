...
#################################################################################################################
dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/turkey5.csv'), delimiter=',', quotechar='"')
#ataReader = csv.reader(open('/app/turkey5.csv'), delimiter=',', quotechar='"')
#################################################################################################################
