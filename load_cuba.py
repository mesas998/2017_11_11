...
#################################################################################################################
#ataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/cuba.csv','r'), delimiter=',', quotechar='"')
dataReader = csv.reader(open('/app/cuba.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    # 5) link
    try:
        poc.link = 'http://nvdatabase.swarthmore.edu/content/cuban-hunger-strike-frees-political-prisoners-2010'
        print('20:', poc.tag)
    except:
        pass
    ...
    # 7)
    list2 = row[1][:]+" "+row[2][:]+" "+row[3][:]+" "+row[4][:]+" "+row[5][:]
    print('22:', list2)
