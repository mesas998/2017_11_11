var s_Host = window.location.hostname.toLowerCase();
        ...
        {
            s_adobe_account = "adbacdcprod";
        }
        else
        {
            s_adobe_account = "adbacdcqa";
        }
        ...
        function s_adobe_doPlugins(s_adobe) {
            ...
            if (!s_adobe.campaign) {
                s_adobe.campaign = s_adobe.eVar6 = s_adobe.getQueryParam('sdid,trackingid,s_cid,s_rtid');
        ...
        **/
        ...
        if (!s_adobe.__ccucw) {
            ...
            function c_w(k, v, e) {
                ...
                } else { sv += ' ' + k + '=' + s_adobe.ape(v) + ';'; sc = 1; } sv = sv.replace(/%00/g, '');
                pv = pv.replace(/%00/g, ''); if (sc) s_adobe.c_wr(sn, sv, 0); if (pc) {
                    t = pv; while (t && t.indexOf(';') != -1) {
                        var t1 = parseInt(t.substring(t.indexOf('|') + 1, t.indexOf(';')));
                        t = t.substring(t.indexOf(';') + 1); ht = ht < t1 ? t1 : ht;
                    } d.setTime(ht); s_adobe.c_wr(pn, pv, d);
                }
        ...
        + "var s=s_c_il[" + s_adobe._in + "];if(!s.getPPVid)return;var dh=Math.max(Math."
