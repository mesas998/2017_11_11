...
############################################################################################################
#ataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/ethiopia.csv'), delimiter=',', quotechar='"')
dataReader = csv.reader(open('/app/ethiopia.csv'), delimiter=',', quotechar='"')
############################################################################################################
for row in dataReader:
  ...
  try:
    ...
    # 5) link
    try:
        poc.link = 'https://en.wikipedia.org/wiki/Category:Amnesty_International_prisoners_of_conscience_held_by_Ethiopia'
    except:
        pass

    # 6) description
    list2 = row[2][:]+" "+row[3][:]+' '+row[3][:]+' '+row[4][:] +' '+row[5][:]+' '+row[6][:]
    print('22:', list2)
