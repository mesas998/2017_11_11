...
#################################################################################################################
#ataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/dprk2.csv'), delimiter=',', quotechar='"')
dataReader = csv.reader(open('/app/dprk2.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'https://en.wikipedia.org/wiki/List_of_foreign_nationals_detained_in_North_Korea'
        print('30b')
    except:
        pass
