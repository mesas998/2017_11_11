...
#################################################################################################################
#ataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/DRCongo.csv'), delimiter=',', quotechar='"')
dataReader = csv.reader(open('/app/DRCongo.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'https://www.hrw.org/news/2016/11/16/dr-congo-political-prisoners-detention'
        print('30b')
    except:
        pass
