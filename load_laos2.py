...
if 'Users' in (os.environ['HOME']):
  dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/laos2.csv'), delimiter=',', quotechar='"')
else:
  dataReader = csv.reader(open('/app/laos2.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'https://www.fidh.org/en/region/asia/laos/three-government-critics-arbitrarily-arrested-detained-incommunicado'
        print('30b')
    except:
        pass
