...
#################################################################################################################
#ataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/azerbaijan1.csv'), delimiter=',', quotechar='"')
dataReader = csv.reader(open('/app/azerbaijan1.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'http://assembly.coe.int/nw/xml/XRef/Xref-XML2HTML-en.asp?fileid=19217&lang=en'
        print('30b')
    except:
        pass
