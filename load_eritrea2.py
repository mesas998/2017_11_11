...
#################################################################################################################
dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/eritrea2.csv'), delimiter=',', quotechar='"')
#ataReader = csv.reader(open('/app/eritrea2.csv'), delimiter=',', quotechar='"')
#################################################################################################################
