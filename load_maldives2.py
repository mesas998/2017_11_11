...
if 'Users' in (os.environ['HOME']):
  dataReader = csv.reader(open('/Users/michaelsweeney/epa7658577/maldives2.csv'), delimiter=',', quotechar='"')
else:
  dataReader = csv.reader(open('/app/maldives2.csv'), delimiter=',', quotechar='"')
#################################################################################################################
for row in dataReader:
  ...
  try:
    ...
    try:
        print('30a')
        poc.link = 'https://www.article19.org/data/files/pdfs/publications/maldives-press-freedom-mission-report.pdf'
        print('30b')
    except:
        pass
